...
import static vaccino.Individuo.TROVA_PER_ID;
import static vaccino.Individuo.TROVA_TUTTI;

@Entity
@NamedQueries({
    @NamedQuery(name = TROVA_TUTTI, query = "SELECT i FROM Individuo i"),
    @NamedQuery(name = TROVA_PER_ID, query = "SELECT i FROM Individuo i WHERE i.id = :id"),
...
public class Individuo implements Serializable{
    public static final String TROVA_TUTTI = "Individuo.trovaTutti";
    public static final String TROVA_PER_ID = "Individuo.trovaPerId";
